...
from lib.utils.torchsparse_utils import initial_voxelize, point_to_voxel, voxel_to_point
...
class SPVCNN(nn.Module):
    ...
    def __init__(self, d_in=4, **kwargs):
        super().__init__()
        ...
        d_linear_in = kwargs.get('d_linear_in', d_in)
        self.fc_in = nn.Linear(d_in, d_linear_in)
        self.stem = nn.Sequential(
            spnn.Conv3d(d_linear_in, cs[0], kernel_size=3, stride=1),
